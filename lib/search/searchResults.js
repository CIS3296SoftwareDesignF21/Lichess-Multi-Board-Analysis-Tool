function searchResults(objectArray) {
    ...
    document.getElementById("searchResults").style.cssText = 'height:15rem;width:70rem;overflow-y:scroll;';
    ...
    if (objectArray) {
        ...
        function insertData(object) {
            ...
            createButton.innerHTML = '<button id="addButton" class="button">Add</button>';
            createButton.onclick = () => createBoard(object.moves, object.players.black.user.name, object.players.white.user.name, date);
